...
def register():
    ...
    while True:
        ...
        if not is_valid:
            ...
            print("💡 Требования: 6-16 символов, только английские буквы и цифры, не начинается с цифры\n")
            continue
        ...
        try:
            ...
            cursor.execute('SELECT user_id FROM public."Users" WHERE login = %s', (login,))
    ...
    while True:
        ...
        if not is_valid:
            print(f"❌ {error_message}")
            print("💡 Требования: 8-32 символа, минимум 1 буква, 1 цифра и 1 специальный символ\n")
            continue
        break
