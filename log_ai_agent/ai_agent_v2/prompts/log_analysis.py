...
СНАЧАЛА выведи секцию ---GROUPS--- с JSON-массивом групп событий:
...
[
  {{
    ...
    "events": [
      {{
        "description": "Неудачная аутентификация admin с IP 89.23.74.19",
    ...
    "description": "Зафиксирована серия неудачных попыток SSH-аутентификации для пользователя admin с IP 89.23.74.19."
  }},
  {{
    "group_id": "g2",
    "events": [...],
...
- Описания событий должны быть краткими (до 200 символов).
- Ключевые слова (5-10 терминов на русском): тип атаки, инструменты, техники, индикаторы, команды, имена файлов/процессов, уязвимости и т.д.
