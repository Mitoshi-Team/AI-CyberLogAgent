...
class GigaChatRAG:
    ...
    def __init__(self, credentials: str, base_url: str = "https://api.gigachat.ru", model: str = "GigaChat", temperature: float = 0.5):
        """
    ...
    def setup_rag(self, texts: list, embedding_model: str = "sentence-transformers/all-MiniLM-L6-v2"):
        """
