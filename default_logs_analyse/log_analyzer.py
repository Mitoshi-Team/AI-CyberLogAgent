...
from settings_analyse import PROCESSED_LOG_PATH, INCIDENTS_OUTPUT_PATH, \
    LOG_FILE_ENCODING
...
class LogAnalyzer:
    ...
    def __init__(self):
        ...
        self.context_indicators = {
            ...
            'user_impact': [r'users affected', r'customers impacted', r'service disruption'],
    ...
    def _calculate_context_score(self, lines: List[str], line_idx: int) -> Dict[str, Any]:
    ...
    def _extract_context(self, lines: List[str], line_idx: int, context_size: int = 5) -> str:
        """
    ...
    def _assess_incident_severity(self, base_confidence: float, context_score: float) -> str:
    ...
    def analyze_log_file(self, file_path: Path) -> List[Dict[str, Any]]:
        ...
        try:
            with open(file_path, 'r', encoding=LOG_FILE_ENCODING) as f:
        ...
        for line_num, line in enumerate(lines, 1):
            ...
            if self._matches_pattern(line, self.incident_patterns):
                ...
                # Assess severity
                severity = self._assess_incident_severity(base_confidence, context_analysis['score'])
                ...
                logger.info(f"Incident detected at line {line_num} with confidence {total_confidence:.2f} and severity {severity}")
    ...
    def analyze_logs(self) -> Dict[str, Any]:
        ...
        logger.info(f"Analysis completed. Total incidents found: {results['total_incidents']}")
